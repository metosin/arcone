...
--
-- pgjwt could be installed as an extension, but that would require custom
-- postgres image with pgjwt installed as an extension.
--
-- This file is from https://github.com/michelp/pgjwt/blob/master/pgjwt--0.2.0.sql
-- Only the schema is changed to 'jwt'.
--
